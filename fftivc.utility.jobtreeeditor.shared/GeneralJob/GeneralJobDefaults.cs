...
public class GeneralJobDefaults
{
    ...
    private static readonly GeneralJobRecord DefaultKnight = new() 
    {
        ...
        Comment = "",
        RequiredJobExp = [.. DefaultExp],
        Prerequisites = [new(GeneralJobKey.Squire, 2, LevelRequirementPosition.BranchRight)],
    ...
    private static readonly GeneralJobRecord DefaultArcher = new()
    {
        ...
        Comment = "",
        RequiredJobExp = [.. DefaultExp],
        Prerequisites = [new(GeneralJobKey.Squire, 2, LevelRequirementPosition.BranchLeft)],
    ...
    private static readonly GeneralJobRecord DefaultWhiteMage = new()
    {
        ...
        Comment = "",
        RequiredJobExp = [.. DefaultExp],
        Prerequisites = [new(GeneralJobKey.Chemist, 2, LevelRequirementPosition.BranchLeft)],
    ...
    private static readonly GeneralJobRecord DefaultBlackMage = new()
    {
        ...
        Comment = "",
        RequiredJobExp = [.. DefaultExp],
        Prerequisites = [new(GeneralJobKey.Chemist, 2, LevelRequirementPosition.BranchRight)],
